<div align="center">
  ...
  <p>
    <b>🎓 Engenheiro da Computação em formação pela USP (EESC/ICMC)</b><br>
...
| :--- | :--- | :--- |
| **☁️ Nuvio** | Sistema de monitoramento climático global com consumo de APIs REST. | `Python`, `Flask` |
| **🔥 SPARQ** | Detecção de focos de incêndio via sensores IoT e análise geoclimática. | `Python`, `IoT` |
| **⛽ Red Line** | Simulação multiplataforma para gestão operacional no setor de óleo e gás. | `C#`, `React Native` |
...
<div align="center">
  ...
  <img height="180em" src="https://github-readme-stats-sigma-five.vercel.app/api/top-langs/?username=dev-DanielSilva&layout=compact&theme=nord&hide_border=true&hide=html,css,shell" />
</div>
